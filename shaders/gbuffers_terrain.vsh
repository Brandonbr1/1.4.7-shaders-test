...
#define WAVING_FIRE
//#define WAVING_WATER //not working, use gbuffers_water.vsh
...
void main() {
	...
	//ambientFire = texture2D(lightmap,vec2(lmcoord.s,1./32.)).rgb;
	//ambientSky  = texture2D(lightmap,vec2(1./32.,lmcoord.t)).rgb;
	//vambient = texture2D(lightmap, vec2(lmcoord.s,0.5/16.)).rgb + texture2D(lightmap, vec2(0.5/16., lmcoord.t)).rgb * 0.6;
